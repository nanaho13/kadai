                ...
                <table border="0">
                    ...
                    <tr>
                        <div class="form-control">
                            ...
                            <td class="form-control"><input type="email" maxlength="100" pattern="^[0-9A-Za-z@\-.]+$" name="mail" size=35 class="text" id="mail" value="<?php if( !empty($_POST['mail']) ){ echo $_POST['mail']; } ?>">
                                <p>Error Message</p>
                            </td>
                        </div>
                    </tr>
                    ...
                    <tr>
                        <div class="form-control">
                            ...
                            <td class="form-control"><input type="text" maxlength="10" pattern="[ぁ-んァ-ヶｦ-ﾟ一-龠０-９0-9\-\sー]+" name="address_1" size=35 class="text" id="address_1" value="<?php if( !empty($_POST['address_1']) ){ echo $_POST['address_1']; } ?>">
                                <p>Error Message</p>
                            </td>
                        </div>
                    </tr>
                    <tr>
                        <div class="form-control">
                            ...
                            <td class="form-control"><input type="text" maxlength="100" pattern="[ぁ-んァ-ヶｦ-ﾟ一-龠０-９0-9\-\sー]+" name="address_2" size=35 class="text" id="address_2" value="<?php if( !empty($_POST['address_2']) ){ echo $_POST['address_2']; } ?>">
                                <p>Error Message</p>
                            </td>
                        </div>
                    </tr>
